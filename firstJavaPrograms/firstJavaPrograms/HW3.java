...
//Gregory Cooper, CSCI 1301 section C, February 4, 2018, This program computes the taxable income depending on one's filing status
	
public class HW3 {	
		public static void main(String[] args) {

			Scanner input = new Scanner (System.in);
			// Prompt the user to enter filing status with JOptionPane
			...
			//double income = Double.parseDouble( JOptionPane.showInputDialog("Enter the taxable income:"));
			...
			if (status == 0) { // Compute tax for single filers
				...
				if (income <= 18650)
					...
					tax = tax = 18650 * 0.10 + (75900 - 18650) * 0.15 +
					(income - 75900) * 0.25;
					...
					tax = 18650 * 0.10 + (75900 - 18650) * 0.15 +
					(153100 - 75900) * 0.25 + (233350 - 91900) * 0.28 +
					(income - 233350) * 0.33;
				else if (income <= 470700)
					tax = 18650 * 0.10 + (75900 - 18650) * 0.15 +
					(153100 - 75900) * 0.25 + (191650 - 91900) * 0.28 +
				...
				if (income <= 9325)
					...
					tax = 9325 * 0.10 + (37950 - 9325) * 0.15 +
					(76550 - 37950) * 0.25 + (191650 - 91900) * 0.28 +
					(income - 116675) * 0.33;
				else if (income <= 418400)
					tax = 9325 * 0.10 + (37950 - 9325) * 0.15 +
				...
				if (income <= 13350)
					...
					tax = tax = 13350 * 0.10 + (50800 - 13350) * 0.15 +
					(income - 50800) * 0.25;
